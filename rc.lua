...
local strf = '<span font="' .. font .. '" color="#00ff00" background="#000000">%y/%m/%d %H:%M</span>'
...
vicious.register(netwidget, vicious.widgets.net, function(widget, args)
    ...
    return '<span background="#000000" font="' .. font .. '"> <span font ="' .. fontSmall .. '" color="#00ff00">' .. args["{" .. interface .. " down_kb}"] .. 'kbps' .. '</span></span>' end, 10)
...
vicious.register( batwidget, vicious.widgets.bat, '<span background="#000000" font="' .. font .. '"><span font="' .. fontSmall .. '" color="#FFFFFF" background="#000000">$1$2% </span></span>', 30, "BAT0" )

--{{ Uptime Widget }} --
uptimewidget = wibox.widget.textbox()
vicious.register(uptimewidget, vicious.widgets.uptime,
  function (widget, args)
    return string.format('<span background="#000000" font="' .. font .. '"> <span font="' .. fontSmall .. '" color="#00ff00">%2dd %02d:%02d </span></span>', args[1], args[2], args[3])
  end, 61)
...
'<span background="#000000" font="' .. font .. '"> <span font="' .. fontSmall .. '" color="#00ff00">/ ${/ avail_gb}G <span color="#888888">·</span> /home ${/home avail_gb}G </span></span>', 
800)
...
'<span background="#000000" font="' .. font .. '"> <span font="' .. fontSmall .. '" color="#00ff00"> $1 </span></span>', 0.3, "Master")
...
vicious.register(mpdwidget, vicious.widgets.mpd,
  function (widget, args)
    if   args["{state}"] == "Stop" then return '<span background="#000000" font="' .. font .. '"> <span font="' .. fontSmall .. '" color="#00ff00">Not Playing </span></span>'
    else return '<span background="#000000" font="' .. font .. '"> <span font="' .. fontSmall .. '" color="#00ff00">' ..args["{Artist}"]..' - '.. args["{Title}"] ..'</span></span>'
    end
  end)
